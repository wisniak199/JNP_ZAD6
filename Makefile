...
ALL = account bank_system gsb planet bank_builder gkb bank

all: gsb

gsb: gsb.o planet.o bank_system.o account.o bank_builder.o gkb.o bank.o
	$(CC) $(LDFLAGS) -o gsb gsb.o planet.o bank_system.o bank.o account.o bank_builder.o gkb.o
